...
public class Box
{
    ...
    private final int DEFAULT_OFFSET = 10; //10 pixels from the border
    ...
    public Box(Canvas c)
    {
        ...
        upperLeftX = DEFAULT_OFFSET;
        upperLeftY = DEFAULT_OFFSET;
        lowerRightX = width-DEFAULT_OFFSET;
        lowerRightY = height-DEFAULT_OFFSET;
